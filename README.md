...
## 📌 Project Overview
Content strategy teams often struggle to prioritize page updates based on objective performance data. This project builds a repeatable decision-support engine using search performance indicators (impressions, average rank position, and CTR) to predict engagement potential and surface high-value recommendations.

- 📄 **Deployed Research Paper:** [View Published Paper](https://abd12315.github.io/flyrank-capstone/)
- 🎯 **Primary Model:** Random Forest Regressor ($R^2 = 0.999$)
